...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		String Message = JOptionPane.showInputDialog("tell me ur secrets");
		// 3. Now use a pop-up to tell the NEXT user that they can only see the secret
		// message
		// if they can guess the passcode
		String User = JOptionPane.showInputDialog("Whats The Password");
		// 4. If their guess matches the password, show them the secret message
		if (User.equals("1")) {
			JOptionPane.showMessageDialog(null, "Welcome Back, Heres Your Secret, " + Message);
		}
